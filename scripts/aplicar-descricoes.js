...
const descricoes = {
  ...
  "Anel de luz (ring light) portátil para fotos": "Ring light portátil com suporte ajustável para celular, ideal para fotos profissionais e vídeos. Iluminação LED com 3 temperaturas de cor e 10 níveis de brilho. USB recarregável.",
  ...
  "Suporte de celular para carro (ventosa magnética)": "Suporte magnético para celular no carro com ventosa forte que fixa no painel ou para-brisa. Imã potente que segura o celular firmemente. Rotação 360° para visualização em qualquer ângulo.",
  ...
  "Kit de bordado/crochê para iniciantes (com videoaula)": "Kit completo de bordado e crochê para iniciantes com linha, agulhas, bastidor e acessórios. Inclui acesso a videoaulas passo a passo para aprender do zero. Projetos simples e criativos para começar.",
  "Chapéu bucket (pescador) unissex": "Chapéu bucket unissex em algodão com proteção UV, leve e confortável para uso diário. Modelo clássico pescador com aba curta que protege do sol. Disponível em várias cores.",
  ...
  "Limpador de teclado portátil (gel mágico)": "Gel mágico limpador que alcança sujeiras entre as teclas do teclado, painéis de carro e fendas. Não tóxico, reutilizável e não deixa resíduos. Fácil de usar e leva em qualquer lugar.",
  ...
  "Organizador de mesa acrílico (giratório)": "Organizador de mesa acrílico giratório com múltiplos compartimentos para canetas, clipes e acessórios. Design moderno que mantém sua mesa arrumada. Gira 360° para fácil acesso a tudo.",
  "Jogo de tabuleiro em miniatura (viagem)": "Jogo de tabuleiro compacto no formato de estojo, ideal para levar em viagens. Inclui peças magnéticas que não se perdem e tabuleiro dobrável. Diversão garantida em qualquer lugar.",
  ...
  "Luminária de mesa com braço articulado e LED": "Luminária de mesa com braço articulado em alumínio e LED de alta luminosidade com ajuste de intensidade. Design moderno com base estável e pescoço flexível. Ideal para estudo e trabalho.",
  "Fita métrica digital a laser (pequena)": "Fita métrica digital a laser compacta que mede distâncias com precisão de até 40 metros. Display LCD iluminado com medição em metros e polegadas. Ideal para reformas, decoração e marcenaria.",
  ...
  "Necessaire de viagem compacta": "Necessaire compacta em material impermeável com compartimento interno e alça para pendurar. Ideal para organizar cosméticos e itens de higiene em viagens. Leve, resistente e fácil de limpar.",
  "Mochila dobrável impermeável (sacola)": "Mochila dobrável impermeável que se compacta em um pequeno pouch para levar na bolsa. Nylon resistente à água, ideal para emergências, viagens e compras. Capacidade de até 20 litros.",
  "Coleira refletiva com luz LED": "Coleira ajustável com tira refletiva e luz LED recarregável para segurança do pet em passeios noturnos. Visível a longa distância e resistente à água. Confortável para uso contínuo.",
  "Power bank fino 10.000mAh (fino e leve)": "Power bank ultrafino com capacidade de 10.000mAh para carregar seu celular até 3 vezes. Design elegante em alumínio, entrada USB-C e saída rápida de 2.1A. Perfeito para o dia a dia.",
  "Kit de chaves Allen/hexagonais em formato compacto": "Kit de chaves Allen hexagonais em formato compacto tipo canivete com as bitolas mais usadas. Aço de alta resistência com cabo ergonômico. Ideal para montagem de móveis e reparos.",
  "Bolsa de água quente (elétrica e sem fio)": "Bolsa de água quente elétrica portátil com aquecimento rápido e desligamento automático. Revestimento em flanela macia para conforto e segurança. Ideal para cólicas e dores musculares.",
  "Mini ventilador USB recarregável": "Mini ventilador portátil recarregável via USB com 3 velocidades e base de mesa. Silencioso, compacto e com pás protegidas. Ideal para escritório, academia e dias quentes.",
  "Caneta touch universal para tablets": "Caneta touch com ponta precisa compatível com todos os tablets e smartphones. Design fino similar a caneta comum com clipe para prender no bolso. Leve e sem necessidade de pareamento.",
  "Chave de fenda elétrica recarregável (mini)": "Chave de fenda elétrica recarregável compacta com pontas intercambiáveis armazenadas no corpo. Bateria de longa duração e LED na ponta. Ideal para eletrônicos e reparos delicados.",
  "Suporte de parede para mangueira de jardim": "Suporte de parede em metal resistente para organizar a mangueira de jardim. Instalação simples com parafusos e buchas inclusos. Mantém a mangueira sempre pronta para usar.",
  "Comedouro lento para cães (labirinto)": "Comedouro lento tipo labirinto que estimula a alimentação mais lenta, prevenindo engasgos e obesidade. Design divertido em material atóxico. Lavável e resistente para cães de todos os portes.",
  "Cabo de carregamento magnético (tipo retrátil)": "Cabo magnético tipo retrátil com ponta que se encaixa automaticamente. Compatível com USB-C e Micro USB. Design que não embaraça e fácil de transportar.",
  "Brinquedo interativo para gato (vara com pena)": "Brinquedo interativo com vara flexível e pena colorida que desperta o instinto de caça do gato. Estímulo ao exercício e ao vínculo entre tutor e pet. Leve e resistente.",
  "Cama de cachorro/gato aquecida (autoaquecível)": "Cama autoaquecível para pets com tecnologia que reflete o calor corporal sem eletricidade. Confortável, lavável e com base antiderrapante. Ideal para dias frios.",
  "Tapete higiênico reutilizável lavável": "Tapete higiênico reutilizável para pets com camada impermeável que absorve urina sem vazar. Lavável em máquina, ecológico e econômico. Ideal para filhotes e adestramento.",
  "Kit de desenho profissional (lápis + carvão) para iniciantes": "Kit de desenho profissional com lápis grafite, carvão vegetal, esfuminho e borracha. Estojo compacto para iniciantes e artistas. Materiais de alta qualidade para sombreamento e detalhes.",
  "Abridor de garrafas automático (elétrico)": "Abridor de garrafas automático elétrico que remove rolhas com um toque. Funciona com pilhas e é compatível com a maioria dos tamanhos de rolha. Design elegante em aço escovado.",
  "Capa de chuva compacta (tamanho bolso)": "Capa de chuva compacta que cabe no bolso e se abre em segundos. Poliéster resistente à água com costura selada. Leve e ideal para imprevistos.",
  "Sensor de movimento com luz LED interna": "Sensor de movimento com luz LED embutida que acende automaticamente ao detectar presença. Instalação simples com fita adesiva ou parafusos. Perfeito para corredores, escadas e garagens.",
  "Luz de cabeceira 3D (efeito cubo flutuante)": "Luminária 3D com efeito cubo flutuante que cria ilusão de ótica com luzes LED coloridas. Controle remoto para mudança de cor e intensidade. Peça decorativa única para quarto e sala.",
  "Apoio de pulso para teclado em gel": "Apoio de pulso ergonômico em gel de memória que reduz tensão e fadiga durante a digitação. Base antiderrapante que não desliza. Compatível com teclados padrão e mecânicos.",
  "Mini grampeador sem esforço": "Mini grampeador compacto com alavanca que reduz o esforço necessário. Design leve e portátil que cabe em qualquer estojo. Ideal para escritório, escola e uso doméstico.",
  "Caneca colorida que muda de cor com calor": "Caneca mágica que revela imagem ou mensagem escondida quando recebe líquido quente. Cerâmica de alta qualidade com capacidade de 300ml. Presente criativo e divertido.",
  "Kit de culinária infantil (forma de moldar arroz/legumes)": "Kit divertido para transformar arroz e legumes em formas lúdicas que incentivam as crianças a comer melhor. Moldes de material atóxico e seguros. Fácil de usar e lavar.",
  "Mini projetor de estrelas/galáxia no teto": "Mini projetor noturno que transforma o teto em um céu estrelado ou galáxia com cores vibrantes. Rotação automática e ajuste de foco. Ideal para relaxamento e quarto infantil.",
  "Caderno inteligente (reutilizável) + caneta apagável": "Caderno inteligente com páginas reutilizáveis que podem ser apagadas com água ou pano úmido. Inclui caneta especial com tinta borrável. Reduz desperdício de papel e prático para anotações.",
  "Fidget spinner de metal (gira e dura muito)": "Fidget spinner de metal com rolamento de cerâmica que gira por minutos sem parar. Design aerodinâmico e peso equilibrado. Alivia estresse e melhora a concentração.",
  "Máquina de algodão-doce portátil (elétrica, pequena)": "Máquina elétrica portátil para fazer algodão-doce em casa em poucos minutos. Fácil de usar, limpar e guardar. Diversão garantida para festas e encontros.",
  "Pente desembaraçador mágico": "Pente desembaraçador com cerdas flexíveis que deslizam pelos fios sem puxar ou quebrar. Design ergonômico com almofada que se adapta ao couro cabeludo. Ideal para todos os tipos de cabelo."
};
...
async function main() {
  ...
  for (const p of rows) {
    const d = descricoes[p.nome];
    if (!d) {
      console.log('FALTA descricao para:', p.nome);
      continue;
    }
    await pool.query('UPDATE products SET descricao = $1 WHERE id = $2', [d, p.id]);
  }

  const { rows: v } = await pool.query("SELECT COUNT(*) AS total, SUM(CASE WHEN descricao IS NULL OR descricao = '' THEN 1 ELSE 0 END) AS vazias FROM products");
  console.log('Total no banco:', v[0].total, '| Vazias:', v[0].vazias);

  const { rows: amostra } = await pool.query('SELECT nome, LEFT(descricao, 100) AS d FROM products LIMIT 3');
